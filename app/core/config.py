...
class Settings:
    ...
    # Data files for Treatment    
    PRECAUTIONS_DATA_PATH = DATA_DIR / "precautions_df.csv"
    WORKOUT_DATA_PATH = DATA_DIR / "workout_df.csv"
    DESCRIPTION_DATA_PATH = DATA_DIR / "Disease_Description.csv"
    MEDICATIONS_DATA_PATH = DATA_DIR / "medications.csv"
    DIETS_DATA_PATH = DATA_DIR / "diets.csv"
    ...
    # Data files for doctor
    DOCTOR_DATA_PATH = DATA_DIR / "Doctor_Versus_Disease.csv"
    

    # Model for Treatment 
    SUPPORT_VECTOR_CLASSIFICATION_MODEL = MODEL_DIR / "svc.pkl"
